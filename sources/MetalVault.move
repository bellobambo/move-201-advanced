module bambo_addr::metal_vault{
    ...
    fun get_client_balance(account: address, asset: u64) acquires MetalVault{
        ...
        if(asset == GOLD){
            ...
            read_balances(gold.g28, utf8(b"58 Grams"));
            read_balances(gold.g28, utf8(b"114 Grams"));
        }   
        else{
            read_balances(silver.g28, utf8(b"28 Grams"));
            read_balances(silver.g28, utf8(b"58 Grams"));
            read_balances(silver.g28, utf8(b"114 Grams"));
        }
    }
